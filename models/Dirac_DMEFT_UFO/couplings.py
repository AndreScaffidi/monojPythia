...
GC_52 = Coupling(name = 'GC_52',
                 value = '(C61*complex(0,1))/Lambda**2',
                 order = {'NP':1})

GC_53 = Coupling(name = 'GC_53',
                 value = '(C62*complex(0,1))/Lambda**2',
                 order = {'NP':1})

GC_54 = Coupling(name = 'GC_54',
                 value = '(C63*complex(0,1))/Lambda**2',
                 order = {'NP':1})

GC_55 = Coupling(name = 'GC_55',
                 value = '(C64*complex(0,1))/Lambda**2',
                 order = {'NP':1})

GC_56 = Coupling(name = 'GC_56',
                 value = '(aS*C71*complex(0,1))/(3.*cmath.pi*Lambda**3)',
                 order = {'NP':1,'QCD':2})

GC_57 = Coupling(name = 'GC_57',
                 value = '-(aS*C72)/(3.*cmath.pi*Lambda**3)',
                 order = {'NP':1,'QCD':2})

GC_58 = Coupling(name = 'GC_58',
                 value = '-(aS*C73*complex(0,1))/(16.*cmath.pi*Lambda**3)',
                 order = {'NP':1,'QCD':2})

GC_59 = Coupling(name = 'GC_59',
                 value = '(aS*C74)/(16.*cmath.pi*Lambda**3)',
                 order = {'NP':1,'QCD':2})

GC_60 = Coupling(name = 'GC_60',
                 value = '(aS*C71*G)/(3.*cmath.pi*Lambda**3)',
                 order = {'NP':1,'QCD':3})

GC_61 = Coupling(name = 'GC_61',
                 value = '(aS*C72*complex(0,1)*G)/(3.*cmath.pi*Lambda**3)',
                 order = {'NP':1,'QCD':3})

GC_62 = Coupling(name = 'GC_62',
                 value = '-(aS*C73*G)/(8.*cmath.pi*Lambda**3)',
                 order = {'NP':1,'QCD':3})

GC_63 = Coupling(name = 'GC_63',
                 value = '-(aS*C74*complex(0,1)*G)/(8.*cmath.pi*Lambda**3)',
                 order = {'NP':1,'QCD':3})

GC_64 = Coupling(name = 'GC_64',
                 value = '-(aS*C71*complex(0,1)*G**2)/(3.*cmath.pi*Lambda**3)',
                 order = {'NP':1,'QCD':4})

GC_65 = Coupling(name = 'GC_65',
                 value = '(aS*C72*G**2)/(3.*cmath.pi*Lambda**3)',
                 order = {'NP':1,'QCD':4})
